...
//    private lateinit var ehrStateToShare: EHRShareAgreementState
//
//    @Before
//    fun setup() {
...
//        nodeB.registerInitiatedFlow(ActivateEHRFlowResponder::class.java)
//        nodeA.registerInitiatedFlow(RequestShareEHRAgreementFlowResponder::class.java)
//        nodeA.registerInitiatedFlow(ShareEHRFlowResponder::class.java)
//        ehrStateToShare = createActiveEHRShareAgreementState()
//    }
//
//    @After
...
//
//    // helper functions
//    private fun createActiveEHRShareAgreementState(): EHRShareAgreementState {
//
...
//        }
//        return states.last().state.data.copy(status = EHRShareAgreementStateStatus.ACTIVE)
//    }
//
//
//
...
//        val future2 = nodeA.startFlow(ActivateEHRFlow(partyB, ehrStateToShare.linearId))
//        mockNetwork.runNetwork()
...
//        val future = nodeA.startFlow(ActivateEHRFlow(partyB, ehrStateToShare.linearId))
//        mockNetwork.runNetwork()
